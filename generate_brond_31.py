...
"""
Download BROND 3.1 data from IPPE(Institute for Physics
and Power Engineering) and convert it to a HDF5 
library for use with OpenMC.
"""
...
parser.add_argument('--download', action='store_true',
                    help='Download files from IPPE')
parser.add_argument('--no-download', dest='download', action='store_false',
                    help='Do not download files from IPPE')
...
parser.add_argument('--libver', choices=['earliest', 'latest'],
                    ...
                    "performance")
parser.add_argument('-r', '--release', choices=['3.1'], default='3.1',
...
release_details = {
    '3.1': {
        'base_url': 'https://www.vant.ippe.ru/images/brond/',
        'compressed_files': ['brond.zip'],
        'endf_files': endf_files_dir.rglob('*.dat'),
        'metastables': endf_files_dir.rglob('*m.dat'),
        'compressed_file_size': '0.12 GB',
        'uncompressed_file_size': '0.54 GB'
    }
}
