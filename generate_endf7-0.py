...
temperatures = [565.0, 600.0, 900.0, 1200.0]
...
release_details = {
    'b7.0': {
        'neutron': {
            'base_url': 'https://www.nndc.bnl.gov/endf/b7.0/zips/',
            'compressed_files': ['n-ENDF-VII0.endf.zip',
                                 'tsl-ENDF-VII0.endf.zip'],
            'checksums': ['f327a02c25537f4342b6babf2ce61214',
                          '3cb015a387f2617c9c99aca57cf5d29c'],
            'file_type': 'endf',
            ...
            'compressed_file_size': 99.1,
            'uncompressed_file_size': 538.8
        },
        'photon': {
            'base_url': 'https://www.nndc.bnl.gov/endf/b7.0/zips/',
            'compressed_files': ['photoat-ENDF-VII0.endf.zip',
                                 'atom-ENDF-VII0.endf.zip'],
            'checksums': ['df02b005008dfa9bd56a0ac9e140d4ad',
                          'e05a39d213b28ad6f9c6bdc85407a5b2'],
            'file_type': 'endf',
